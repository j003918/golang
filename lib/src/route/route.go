...
func Run(mux http.Handler, addr string, withTLS bool, crtPath, keyPath string) {
	...
	go func() {
		if withTLS {
			fmt.Println(srv.ListenAndServeTLS(crtPath, keyPath))
		} else {
